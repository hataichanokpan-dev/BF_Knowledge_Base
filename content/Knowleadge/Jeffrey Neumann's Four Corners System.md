## 🗺️ ภาพรวมก่อนเริ่ม — ทำไม Neumann ถึงทำได้

วิธีของ [[Jeffrey Neumann]] คือ [[High Conviction Swing Trading]] (สัปดาห์ถึงเดือน) บนหุ้น [[Microcap Breakout]] ที่มี Four Corners align พร้อมกัน โดยผสม Technical กับ Fundamental และ Sector Theme เข้าด้วยกัน ซึ่งมีความใกล้เคียงกับแนวทางของ [[Jesse Stine]] แต่**[[เน้น Sector Cluster และ Catalyst Timing]] หนักกว่า**

> "ผมไม่ได้เล่นตลาด ผมรอให้ทุกอย่างเรียงตัวสวย" - Jeffrey Neumann

---

## ส่วนที่ 1 — Four Corners Framework: 4 เกณฑ์ต้องพร้อมพร้อมกัน

Neumann ไม่ได้มองหุ้นเป็นตัวๆ ไป แต่มองว่าหุ้นแต่ละตัวต้องมี 4 มิติ "ตอบโจทย์พร้อมกัน" ถึงจะลงทุน ขาด Corner ไหน = ไม่เข้า (รอต่อ)
...
## ส่วนที่ 2 — WAVE 1: STRUCTURAL FILTER (โครงสร้างพร้อมระเบิด)
...
> 💡 **หลักการ:** Float ต่ำ = มีคนถือน้อย เมื่อ Demand พุ่ง ราคาขึ้นได้แรง
...
> 💡 **หลักการ:** Institutional ต่ำ = เข้าก่อน Big Money
...
## ส่วนที่ 3 — WAVE 2: TECHNICAL IGNITION (จับจังหวะตื่น)
...
> 💡 **หลักการ:** Volume = Footprint ของ Smart Money
...
## ส่วนที่ 4 — WAVE 3: SECTOR CLUSTER (เงินไหลเข้ากลุ่ม)
...
> 🔑 **"Golf Course Indicator":** ถ้าได้ยินคนทั่วไปพูดถึง sector นั้นบนสนามกอล์ฟ = เข้าสู่ Mania Phase = EXIT
...
## ส่วนที่ 5 — WAVE 4: CATALYST AUDIT (เหตุผลเคลื่อนไหว)
...
## ส่วนที่ 6 — NEUMANN SCORE: รวมทุก Wave
...
## ส่วนที่ 7 — Risk Management: กฎเหล็ก 5 ข้อ
...
## ส่วนที่ 8 — Entry & Exit Rules

### Entry Strategy

```
1. ทั้ง 4 Wave align
2. Start with test position
3. Pyramid on conviction (follow through)
4. Pyramid เข้า Lead Dog ใน sector
```
...
- **Book:** *Unknown Market Wizards* by Jack Schwager - Chapter: Jeffrey Neumann Profile
- **Course:** [[Jeffrey Neumann Trading Course]] (Episteme, 11 chapters)
- **Oracle:** `learning-1774762386004-c3l5bz`
- **Project:** [[Neumann Stock Scanner Implementation]]

---

> 🔑 **One-Liner ของ Neumann:** "ผมไม่ได้เล่นตลาด ผมรอให้ทุกอย่างเรียบตัวสวย" — ทั้ง 4 Corners ต้อง align ถึงจะเข้า
